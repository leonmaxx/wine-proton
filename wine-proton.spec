...
Requires:       wine-proton-fonts = %{version}-%{release}

# x86-32 parts
%ifarch %{ix86} x86_64
%if 0%{?fedora} || 0%{?rhel}
Requires:       wine-proton-core(x86-32) = %{version}-%{release}
Requires:       wine-proton-capi(x86-32) = %{version}-%{release}
Requires:       wine-proton-cms(x86-32) = %{version}-%{release}
Requires:       wine-proton-ldap(x86-32) = %{version}-%{release}
Requires:       wine-proton-twain(x86-32) = %{version}-%{release}
Requires:       wine-proton-pulseaudio(x86-32) = %{version}-%{release}
%if 0%{?fedora} >= 10 || 0%{?rhel}
Requires:       wine-proton-openal(x86-32) = %{version}-%{release}
%endif
%if 0%{?fedora} || 0%{?rhel} >= 7
...
# x86-64 parts
%ifarch x86_64
Requires:       wine-proton-core(x86-64) = %{version}-%{release}
Requires:       wine-proton-capi(x86-64) = %{version}-%{release}
Requires:       wine-proton-cms(x86-64) = %{version}-%{release}
Requires:       wine-proton-ldap(x86-64) = %{version}-%{release}
Requires:       wine-proton-twain(x86-64) = %{version}-%{release}
Requires:       wine-proton-pulseaudio(x86-64) = %{version}-%{release}
%if 0%{?fedora} >= 10 || 0%{?rhel} >= 6
Requires:       wine-proton-openal(x86-64) = %{version}-%{release}
%endif 
%if 0%{?fedora} || 0%{?rhel} >= 7
...
Requires:       wine-proton-capi = %{version}-%{release}
Requires:       wine-proton-cms = %{version}-%{release}
Requires:       wine-ldap = %{version}-%{release}
Requires:       wine-proton-twain = %{version}-%{release}
Requires:       wine-proton-pulseaudio = %{version}-%{release}
Requires:       wine-proton-openal = %{version}-%{release}
%if 0%{?fedora}
...
# aarch64 parts
%ifarch aarch64
Requires:       wine-proton-core(aarch-64) = %{version}-%{release}
Requires:       wine-proton-capi(aarch-64) = %{version}-%{release}
Requires:       wine-proton-cms(aarch-64) = %{version}-%{release}
Requires:       wine-proton-ldap(aarch-64) = %{version}-%{release}
Requires:       wine-proton-twain(aarch-64) = %{version}-%{release}
...
# require -filesystem
Requires:       wine-proton-filesystem = %{version}-%{release}
...
Requires:       wine-proton-common = %{version}-%{release}
%if 0%{?fedora} >= 15 || 0%{?rhel} >= 7
Requires:       wine-proton-systemd = %{version}-%{release}
%endif
%if 0%{?rhel} == 6
...
Requires:      wine-proton-arial-fonts = %{version}-%{release}
Requires:      wine-proton-courier-fonts = %{version}-%{release}
Requires:      wine-proton-fixedsys-fonts = %{version}-%{release}
Requires:      wine-proton-small-fonts = %{version}-%{release}
Requires:      wine-proton-system-fonts = %{version}-%{release}
Requires:      wine-proton-marlett-fonts = %{version}-%{release}
Requires:      wine-proton-ms-sans-serif-fonts = %{version}-%{release}
Requires:      wine-proton-tahoma-fonts = %{version}-%{release}
# times-new-roman-fonts are available with compholio-patchset, only.
Requires:      wine-proton-times-new-roman-fonts = %{version}-%{release}
Requires:      wine-proton-symbol-fonts = %{version}-%{release}
Requires:      wine-proton-wingdings-fonts = %{version}-%{release}
...
Requires: wine-proton-core = %{version}-%{release}
# midi output
Requires: wine-proton-alsa%{?_isa} = %{version}-%{release}
...
tar xzf %{SOURCE12}
patch -p1 <wine-d3d9-patches-wine-d3d9-%{version}/d3d9-helper.patch
...
%{_libdir}/wine/amd_ags_x64.dll.so
