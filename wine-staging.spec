...
Source12:		wine-d3d9-patches-wine-d3d9-%{version}.tar.gz
Source13:		esync-staging-fixes-r2.patch
Source14:		esync-compat-fixes-r2.patch
Source15:		esync-no_alloc_handle.patch
Source16:		esync-ntdll_spec-fix.patch
...
Requires:       wine-staging-common = %{version}-%{release}
Requires:       wine-staging-desktop = %{version}-%{release}
Requires:       wine-staging-fonts = %{version}-%{release}

# x86-32 parts
%ifarch %{ix86} x86_64
%if 0%{?fedora} || 0%{?rhel}
Requires:       wine-staging-core(x86-32) = %{version}-%{release}
Requires:       wine-staging-capi(x86-32) = %{version}-%{release}
Requires:       wine-staging-cms(x86-32) = %{version}-%{release}
Requires:       wine-staging-ldap(x86-32) = %{version}-%{release}
Requires:       wine-staging-twain(x86-32) = %{version}-%{release}
Requires:       wine-staging-pulseaudio(x86-32) = %{version}-%{release}
%if 0%{?fedora} >= 10 || 0%{?rhel}
Requires:       wine-staging-openal(x86-32) = %{version}-%{release}
%endif
%if 0%{?fedora} || 0%{?rhel} >= 7
Requires:       wine-staging-opencl(x86-32) = %{version}-%{release}
%endif
%if 0%{?fedora} >= 17
Requires:       mingw32-wine-gecko = %winegecko
Requires:       wine-staging-mono = %winemono
%endif
...
# x86-64 parts
%ifarch x86_64
Requires:       wine-staging-core(x86-64) = %{version}-%{release}
Requires:       wine-staging-capi(x86-64) = %{version}-%{release}
Requires:       wine-staging-cms(x86-64) = %{version}-%{release}
Requires:       wine-staging-ldap(x86-64) = %{version}-%{release}
Requires:       wine-staging-twain(x86-64) = %{version}-%{release}
Requires:       wine-staging-pulseaudio(x86-64) = %{version}-%{release}
%if 0%{?fedora} >= 10 || 0%{?rhel} >= 6
Requires:       wine-staging-openal(x86-64) = %{version}-%{release}
%endif 
%if 0%{?fedora} || 0%{?rhel} >= 7
Requires:       wine-staging-opencl(x86-64) = %{version}-%{release}
%endif
%if 0%{?fedora} >= 17
...
# ARM parts
%ifarch %{arm} aarch64
Requires:       wine-staging-core = %{version}-%{release}
Requires:       wine-staging-capi = %{version}-%{release}
Requires:       wine-staging-cms = %{version}-%{release}
Requires:       wine-ldap = %{version}-%{release}
Requires:       wine-staging-twain = %{version}-%{release}
Requires:       wine-staging-pulseaudio = %{version}-%{release}
Requires:       wine-staging-openal = %{version}-%{release}
%if 0%{?fedora}
...
# aarch64 parts
%ifarch aarch64
Requires:       wine-staging-core(aarch-64) = %{version}-%{release}
Requires:       wine-staging-capi(aarch-64) = %{version}-%{release}
Requires:       wine-staging-cms(aarch-64) = %{version}-%{release}
Requires:       wine-staging-ldap(aarch-64) = %{version}-%{release}
Requires:       wine-staging-twain(aarch-64) = %{version}-%{release}
Requires:       wine-staging-pulseaudio(aarch-64) = %{version}-%{release}
Requires:       wine-staging-openal(aarch-64) = %{version}-%{release}
Requires:       wine-staging-opencl(aarch-64) = %{version}-%{release}
Requires:       mingw64-wine-gecko = %winegecko
...
# require -filesystem
Requires:       wine-staging-filesystem = %{version}-%{release}
...
Requires:       wine-staging-common = %{version}-%{release}
%if 0%{?fedora} >= 15 || 0%{?rhel} >= 7
Requires:       wine-staging-systemd = %{version}-%{release}
%endif
%if 0%{?rhel} == 6
...
%if 0%{?staging}
Requires:      wine-staging-arial-fonts = %{version}-%{release}
%else
Obsoletes:     wine-arial-fonts <= %{version}-%{release}
%endif
Requires:      wine-staging-courier-fonts = %{version}-%{release}
Requires:      wine-staging-fixedsys-fonts = %{version}-%{release}
Requires:      wine-staging-small-fonts = %{version}-%{release}
Requires:      wine-staging-system-fonts = %{version}-%{release}
Requires:      wine-staging-marlett-fonts = %{version}-%{release}
Requires:      wine-staging-ms-sans-serif-fonts = %{version}-%{release}
Requires:      wine-staging-tahoma-fonts = %{version}-%{release}
# times-new-roman-fonts are available with compholio-patchset, only.
%if 0%{?staging}
Requires:      wine-staging-times-new-roman-fonts = %{version}-%{release}
%else
Obsoletes:     wine-times-new-roman-fonts <= %{version}-%{release}
Obsoletes:     wine-times-new-roman-fonts-system <= %{version}-%{release}
%endif
Requires:      wine-staging-symbol-fonts = %{version}-%{release}
Requires:      wine-staging-wingdings-fonts = %{version}-%{release}
...
Requires: wine-staging-core = %{version}-%{release}
# midi output
Requires: wine-staging-alsa%{?_isa} = %{version}-%{release}
...
gzip -dc %{SOURCE11} | tar -xf - --strip-components=1
patches/patchinstall.sh DESTDIR="`pwd`" --all

# -W server-Misc_ACL -W server-Object_Types -W advapi32-Token_Integrity_Level -W ntdll-LdrInitializeThunk -W ntdll-RtlCreateUserThread -W advapi32-LsaLookupSids -W kernel32-K32GetPerformanceInfo -W ntdll-NtSuspendProcess
...
tar xzf %{SOURCE12}
patch -p1 <wine-d3d9-patches-wine-d3d9-%{version}/staging-helper.patch
